...
(function () {
    ...
    angular.module('listAppModule', ['ngSanitize', 'kendo.directives', 'jsonMethodModule', 'l8k.UI.DirectiveModule'])
        .controller('listAppController', function ($scope, jsomMethodService) {
            ...
            $scope.selectableorderby = ['name'];//selectableorderby can use string for sigle column and array for multiple columns and function(item) to implement return boolean
            $scope.init = function(){
